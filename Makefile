...
CORE_OBJS = ds4.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_ngram_cache.o ds4_metal.o ds4_layer_pack.o
CPU_CORE_OBJS = ds4_cpu.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_ngram_cache.o ds4_layer_pack.o
else
...
MMQ_OBJS := cuda/mmq/ds4_ggml_stubs.o cuda/mmq/ds4_mmq.o cuda/mmq/ds4_mmq_d2r.o cuda/mmq/quantize.o cuda/mmq/mmid.o cuda/mmq/mmvq.o cuda/mmq/ds4_repack.o cuda/mmq/ds4_qwen_fp4.o
CORE_OBJS = ds4.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_ngram_cache.o ds4_cuda.o ds4_layer_pack.o $(MMQ_OBJS)
CPU_CORE_OBJS = ds4_cpu.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_ngram_cache.o ds4_layer_pack.o
...
ds4-server: ds4_server.o ds4_help.o ds4_kvstore.o ds4_chainstore.o rax.o ds4_gpu_args.o $(CORE_OBJS)
	$(CC) $(CFLAGS) -o $@ ds4_server.o ds4_help.o ds4_kvstore.o ds4_chainstore.o rax.o ds4_gpu_args.o $(CORE_OBJS) $(METAL_LDLIBS)
...
cpu: ds4_cli_cpu.o ds4_server_cpu.o ds4_bench_cpu.o ds4_eval_cpu.o ds4_agent_cpu.o ds4_help.o ds4_web.o ds4_kvstore.o ds4_chainstore.o linenoise.o rax.o ds4_gpu_args_cpu.o $(CPU_CORE_OBJS)
	$(CC) $(CFLAGS) -o ds4 ds4_cli_cpu.o ds4_help.o linenoise.o ds4_gpu_args_cpu.o $(CPU_CORE_OBJS) $(LDLIBS)
	$(CC) $(CFLAGS) -o ds4-server ds4_server_cpu.o ds4_help.o ds4_kvstore.o ds4_chainstore.o rax.o ds4_gpu_args_cpu.o $(CPU_CORE_OBJS) $(LDLIBS)
...
strix-halo:
	$(MAKE) -B ds4 ds4-server ds4-bench ds4-eval ds4-agent \
		CORE_OBJS="ds4.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_ngram_cache.o ds4_rocm.o ds4_rocm_compat.o ds4_rocm_unavailable.o ds4_layer_pack.o $(ROCM_MMQ_OBJS)" \
...
cuda-regression: tests/cuda_long_context_smoke tests/qwen_qsa_select_test tests/qwen_vision_attention_test tests/qwen_fp4_test
	./tests/cuda_long_context_smoke
	./tests/qwen_qsa_select_test
	./tests/qwen_vision_attention_test
	./tests/qwen_fp4_test
...
ds4_ngram_cache.o: ds4_ngram_cache.c ds4_ngram_cache.h
	$(CC) $(CFLAGS) -c -o $@ ds4_ngram_cache.c

tests/test_ngram_cache.o: tests/test_ngram_cache.c ds4_ngram_cache.h
	$(CC) $(CFLAGS) -I. -c -o $@ $<

tests/test_ngram_cache: tests/test_ngram_cache.o ds4_ngram_cache.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)
...
ds4_server.o: ds4_server.c ds4.h ds4_ssd.h ds4_distributed.h ds4_help.h ds4_kvstore.h ds4_chainstore.h rax.h
...
ds4_test.o: tests/ds4_test.c ds4_server.c ds4.h ds4_ssd.h ds4_distributed.h ds4_help.h ds4_kvstore.h ds4_chainstore.h rax.h
...
ds4_server_cpu.o: ds4_server.c ds4.h ds4_ssd.h ds4_distributed.h ds4_help.h ds4_kvstore.h ds4_chainstore.h rax.h
...
tests/test_qwen_vision_engine.o: tests/test_qwen_vision_engine.c ds4.h ds4_image.h
	$(CC) $(CFLAGS) -I. -c -o $@ tests/test_qwen_vision_engine.c

tests/test_qwen_vision_engine: tests/test_qwen_vision_engine.o $(CORE_OBJS)
	$(DS4_LINK) -o $@ $^ $(DS4_LINK_LIBS)
...
tests/test_qwen_vision_image.o: tests/test_qwen_vision_image.c ds4_image.h
	$(CC) $(CFLAGS) -I. -c -o $@ $<

tests/test_qwen_vision_image: tests/test_qwen_vision_image.o ds4_image.o
	$(CC) $(CFLAGS) -o $@ $^ -lm
...
ds4_cuda.o: ds4_cuda.cu ds4_gpu.h ds4_gpu_mgpu.h ds4_glm53_vision_gpu.cuh ds4_qwen35_gpu.cuh ds4_qwen_vision_gpu.cuh ds4_deepseek4_vision_gpu.cuh ds4_image.h ds4_iq2_tables_cuda.inc cuda/mmq/ds4_mmq.h cuda/mmq/ds4_qwen_fp4.h
...
cuda/mmq/ds4_qwen_fp4.o: cuda/mmq/ds4_qwen_fp4.cu cuda/mmq/ds4_qwen_fp4.h cuda/mmq/common.cuh cuda/mmq/mma.cuh cuda/mmq/ds4_ggml_stubs.h
	$(NVCC) $(NVCCFLAGS) -std=c++17 $(MMQ_INCLUDES) -c -o $@ $<
...
tests/qwen_qsa_select_test.o: tests/qwen_qsa_select_test.c ds4_gpu.h
	$(CC) $(CFLAGS) -I. -c -o $@ tests/qwen_qsa_select_test.c

tests/qwen_qsa_select_test: tests/qwen_qsa_select_test.o $(CORE_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)

tests/qwen_vision_attention_test.o: tests/qwen_vision_attention_test.c ds4_gpu.h
	$(CC) $(CFLAGS) -I. -c -o $@ tests/qwen_vision_attention_test.c

tests/qwen_vision_attention_test: tests/qwen_vision_attention_test.o $(CORE_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)

tests/test_qwen_state_cache.o: tests/test_qwen_state_cache.c ds4.h
	$(CC) $(CFLAGS) -I. -c -o $@ tests/test_qwen_state_cache.c

tests/test_qwen_state_cache: tests/test_qwen_state_cache.o $(CORE_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)

tests/test_qwen_disk_kv.o: tests/test_qwen_disk_kv.c ds4.h
	$(CC) $(CFLAGS) -I. -c -o $@ tests/test_qwen_disk_kv.c

tests/test_qwen_disk_kv: tests/test_qwen_disk_kv.o $(CORE_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)

tests/qwen_fp4_test.o: tests/qwen_fp4_test.c cuda/mmq/ds4_qwen_fp4.h
	$(CC) $(CFLAGS) -I. -I$(CUDA_HOME)/include -c -o $@ tests/qwen_fp4_test.c

tests/qwen_fp4_test: tests/qwen_fp4_test.o cuda/mmq/ds4_qwen_fp4.o cuda/mmq/ds4_ggml_stubs.o
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)

tests/qwen_fp4_bench.o: tests/qwen_fp4_bench.c cuda/mmq/ds4_qwen_fp4.h
	$(CC) $(CFLAGS) -I. -I$(CUDA_HOME)/include -c -o $@ tests/qwen_fp4_bench.c
...
tests/test_engine_mgpu_placement: tests/test_engine_mgpu_placement.o ds4_cpu_test_hooks.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_ngram_cache.o ds4_layer_pack.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)

tests/test_sampling.o: tests/test_sampling.c ds4.h
	$(CC) $(CFLAGS) -fno-finite-math-only -DDS4_TEST_HOOKS -I. -c -o $@ $<

tests/test_sampling: tests/test_sampling.o ds4_cpu_test_hooks.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_ngram_cache.o ds4_layer_pack.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)
...
tests/test_engine_mgpu_runtime: tests/test_engine_mgpu_runtime.o ds4_cuda_test_hooks.o ds4_gpu_args.o ds4_kvstore.o rax.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_ngram_cache.o ds4_cuda.o ds4_layer_pack.o $(MMQ_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
...
tests/test_cuda_mixed_batch: tests/test_cuda_mixed_batch.o ds4_cuda_test_hooks.o ds4_gpu_args.o ds4_kvstore.o rax.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_ngram_cache.o ds4_cuda.o ds4_layer_pack.o $(MMQ_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
...
ds4_test: ds4_test.o ds4_help.o ds4_kvstore.o ds4_chainstore.o rax.o $(CORE_OBJS)
ifeq ($(UNAME_S),Darwin)
	$(CC) $(CFLAGS) -o $@ ds4_test.o ds4_help.o ds4_kvstore.o ds4_chainstore.o rax.o $(CORE_OBJS) $(METAL_LDLIBS)
else
	$(DS4_LINK) -o $@ ds4_test.o ds4_help.o ds4_kvstore.o ds4_chainstore.o rax.o $(CORE_OBJS) $(DS4_LINK_LIBS)
endif
...
test: ds4_test ds4_agent_test ds4-eval q4k-dot-test mxfp4-dot-test \
	tests/test_layer_pack tests/test_ngram_cache tests/test_kvstore tests/test_engine_mgpu_placement tests/test_gpu_args \
	tests/test_deepseek4_vision_image tests/test_qwen_vision_image $(SAMPLING_TEST) ds4 ds4-server ds4-bench ds4-agent
	./ds4-eval --self-test-extractors
	./ds4_agent_test
	./ds4_test
	./tests/test_layer_pack
	./tests/test_ngram_cache
	./tests/test_kvstore
	./tests/test_engine_mgpu_placement
	./tests/test_gpu_args
	./tests/test_gpu_args_cli.sh
...
clean:
	rm -f ds4 ds4-server ds4-bench ds4-eval ds4-agent ds4_cpu ds4_native ds4_server_test ds4_test ds4_agent_test gguf-tools/quality-testing/score_official gguf-tools/quality-testing/score_official.o speed-bench/metal_decode_schedule_bench speed-bench/metal_prefill_variant_bench speed-bench/*.o tests/test_q4k_dot tests/test_mxfp4_dot tests/test_mxfp4_metal tests/test_mxfp4_rocm tests/test_mxfp4_cuda tests/test_metal_session_batch tests/test_glm53_kda tests/test_glm53_kda_rocm tests/test_glm53_vision_engine tests/test_glm53_vision_prompt tests/test_deepseek4_vision_image tests/test_qwen_vision_image tests/test_qwen_vision_engine tests/test_qwen_state_cache tests/test_qwen_disk_kv tests/test_kvstore tests/test_gpu_xdev tests/test_gpu_model_cache tests/test_gpu_lookup_cache_strict tests/test_engine_mgpu_refusal tests/test_engine_mgpu_runtime tests/test_engine_correctness tests/test_sampling tests/test_cuda_session_batch tests/test_cuda_mixed_batch tests/*.o *.o tests/cuda_long_context_smoke tests/cuda_long_context_smoke.o tests/qwen_qsa_select_test tests/qwen_qsa_select_test.o tests/qwen_vision_attention_test
