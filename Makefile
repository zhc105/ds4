...
test: ds4_test ds4_agent_test ds4-eval q4k-dot-test mxfp4-dot-test \
	tests/test_layer_pack tests/test_ngram_cache tests/test_engine_mgpu_placement tests/test_gpu_args \
