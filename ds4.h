...
/* Qwen decode passes that ran as one batched forward (CUDA builds). */
uint64_t ds4_test_qwen_batch_count(void);
#endif
 ...
 * archive keeps real turns, and it can read ahead for the pieces to come. */
